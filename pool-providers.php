            ...
            <div class="main-content">
                <div class="jotform-section"> 
                    ...
                    <table class="leads-table">
                        ...
                        <tbody>
                            <?php include 'assets/php/populate-pool.php'; ?>
                        </tbody>
                    </table>
                </div>
            </div>
        ...
        fetch('assets/php/fetchUserData.php?email=' + email)
            ...
            .then(data => {
                ...
                // Handle equipment and insurance files
                    ...
                    // Modify the section where the provider-approved data is set and add logic to hide the button
                    document.getElementById("provider-approved").textContent = data.approved || 'N/A';
                    if (data.approved === 'Yes') {
                        document.getElementById("unlock-account-btn").style.display = 'none';
                    } else {
                        document.getElementById("unlock-account-btn").style.display = 'block';
                    }
            })
